// Line chart: Tool cost ($) averaged per agent, one point per agent in `data` (x-axis =
// agent id, y-axis = the average of tool cost ($) across that agent's selected runs).
